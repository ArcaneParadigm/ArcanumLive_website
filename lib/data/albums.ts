...
const sidheTracks: AlbumTrack[] = [
  ...
  t('Spell of Binding and Bloom',                  'Spellsong – _Spell of Binding and Bloom_ v1B'),
  ...
  t('Dawn Over Tír na nÓg',                        'Uplifting – _Dawn Over Tír na nÓg_ v1'),
  t('The Devil vs Puck',                           'the Devil vs Puck 2v4'),
  t('The Fairy Dirge, Pt. 2',                      'the Fairy Dirge dif ver 2a (2)'),
  t('Dawn Over Tír na nÓg, Pt. 2',                 'Uplifting – _Dawn Over Tír na nÓg_ v1B'),
