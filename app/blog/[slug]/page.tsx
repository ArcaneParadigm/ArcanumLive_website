...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://arcanum.live/blog/${post.slug}`,
      type: 'article',
      publishedTime: post.date,
      authors: ['Glenn Grillo'],
      images: cardImage
        ? [{ url: cardImage, width: 1200, height: 630, alt: post.title }]
    ...
    twitter: {
      ...
      title: post.title,
      description: post.excerpt,
      images: [cardImage ?? '/images/arcanum-portal-v1.jpg'],
    },
    alternates: { canonical: `https://arcanum.live/blog/${post.slug}` },
  }
}
